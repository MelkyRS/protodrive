...
export function UploadManager() {
  ...
  return (
    <Card className="fixed bottom-4 right-4 left-4 sm:left-auto sm:bottom-6 sm:right-6 sm:w-96 shadow-2xl border-border/50 animate-in slide-in-from-bottom-4 sm:slide-in-from-right-4 duration-300 z-100">
      <CardContent className="p-3 sm:p-4">
        ...
        {upload.status === "uploading" && (
          <Progress
            ...
            className="mt-3 sm:mt-4 h-1.5 w-full bg-secondary rounded-full overflow-hidden"
          />
        )}
      </CardContent>
    </Card>
